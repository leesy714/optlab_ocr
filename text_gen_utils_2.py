...
if __name__=='__main__':
    ...
    text_type_list = [text_type_0, text_type_1, text_type_2, text_type_3, text_type_4,
                      text_type_5, text_type_6, text_type_7, text_type_4,
                      text_type_5, text_type_6, text_type_7, text_type_4,
                      text_type_5, text_type_6, text_type_7, text_type_8]
    
    location_list = [(330, 220), (1050, 480), (500, 480), (200, 750), (130, 750),
                     (450, 750), (1100, 750), (1370, 750), (130, 830),
                     (450, 830), (1100, 830), (1370, 830), (130, 910),
                     (450, 910), (1100, 910), (1370, 910), (750, 1720)]

    fontsize_list = [30, 30, 30, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25]
    ...
    img.save('gen_sample/건강보험자격득실확인서_2_gen.png')