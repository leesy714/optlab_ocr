...
class RandomText:
    ...
    def save(self, imgs, ys, idx=0):
        origin_path = "gen_sample"
        label_path = "gen_sample"
...
if __name__ == '__main__':
    ...
    with open('box_data.pickle', 'wb') as f:
        pickle.dump(location_list, f)
    
#     with open('box_data.pickle', 'rb') as f:
#         data = pickle.load(f)
#     print(data)
    
    # location_list 에 두점을 넣으면 box크기에 맞는 글씨를 만들도록 수정
    random_text = RandomText("./template/template-1.png", text_type_list, location_list,
